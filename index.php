   ...
   <div class="content">
    <div class="container">
        <div class="dienthoaimoi">
            ...
            <?php
                $getNewDienThoai = $products->getNewDienThoai($page); 
                foreach($getNewDienThoai as $key=>$value)
                { ?>  
                <div class="col-md-3">      
                            <?php                         
        ...
        <div class="laptopmoi">
            ...
            <?php
                $getNewLapTop = $products->getNewLapTop($page); 
                foreach($getNewLapTop as $key=>$value)
                { ?>  
                <div class="col-md-3">      
                            <?php                         
                            echo "<a href='detail.php?p=".$value['id']."'><img src='images/".$value['image']."'></a> <br>";                          
