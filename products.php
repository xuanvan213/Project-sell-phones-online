...
<body>
   ...
   {
        $getn = $_GET['n'] ;
        $manu_name = substr($getn,0, strlen($getn)-2);
        $type = substr($getn, strlen($getn) - 2);
   }
   else
   {
        $manu_name = "";
   ...
   if($type == "lt")
   {
       $getLaptop =  $products->getLaptop($manu_name);
       ?>     
        <div class="container">
                <div class="row">
                    <?php
                    if(!empty($getLaptop))
                    {
                        foreach($getLaptop as $key=>$value)
                        { ?>
                            <div class="col-md-3">
                                    <?php
                                    ...
                                    echo "<a href='../mobile/addcart.php?id=".$value['id']."' class='cart'><h5>ADD to cart</h5></a> <br>";       
                                    ?>
                            </div>        
                        <?php }  
                    }
   ...
   <?php }
       ...
       $getDienThoai = $products->getDienThoai($manu_name);
       ?>

        <div class="container">
                <div class="row">
                    <?php
                    if(!empty($getDienThoai))
                    {
                        foreach($getDienThoai as $key=>$value)
                        { ?>
                            <div class="col-md-3">
                                    <?php
                                    echo "<img src='images/".$value['image']."'> <br>";                                     
   ...
   <?php } 
    ...
    {
        $getTaiNghe = $products->getTaiNghe($manu_name); ?>
            <div class="container">
                    <div class="row">
                        <?php
                        if(!empty($getTaiNghe))
                        {
                            foreach($getTaiNghe as $key=>$value)
                            { ?>
                                <div class="col-md-3">
                                        <?php
                                        echo "<img src='images/".$value['image']."'> <br>";                                     
        ...
        { 
            $getMayTinhBang = $products->getMayTinhBang($manu_name); ?>
            <div class="container">
                    <div class="row">
                        <?php
                            if(!empty($getMayTinhBang))
                            {
                                foreach($getMayTinhBang as $key=>$value)
                                { ?>
                                    <div class="col-md-3">
                                            <?php
                                            echo "<img src='images/".$value['image']."'> <br>";                                     
