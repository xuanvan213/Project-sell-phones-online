		...
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"><a href="formAddManufactures.php"><i class="icon-plus"></i></a></span>
						<h5>Products</h5>
					</div>
                                ...
                                <?php
                                    ...
                                    foreach($getAllManu as $value)
                                     { ?>
                                        ...
                                        <td><?php echo "<img src='../images/".$value['manu_img']."' width='50%' height='50%'>" ?></td>
                                        <td>
                                            <a href="formUpdateManu.php?id=<?php echo $value['manu_ID']; ?>" class="btn btn-success btn-mini">Edit</a>
                                            <a href="delManu.php?id=<?php echo $value['manu_ID']; ?>" class="btn btn-danger btn-mini">Delete</a>
                                        </td>
							            </tr>
                                   <?php }
                                ?>
