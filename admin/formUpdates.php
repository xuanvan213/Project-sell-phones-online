			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="updateProducts.php?p=<?php echo $id; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<?php 
											...
											{ 
												?>
                                            <option <?php echo $value['type_ID'] == $getProductsById[0]['type_id'] ? 'selected' : ''?>
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<?php 
											...
											{ 	
												?>
												<option <?php echo $value['manu_ID'] == $getProductsById[0]['manu_id'] ? 'selected' : ''?>
                                                value="<?php echo $value['manu_ID']; ?>"> <?php echo $value['manu_name']; ?></option>			
											<?php }
										?>
								...
								<div class="control-group">
									...
									<div class="controls">
									<?php echo "<img src='../images/".$getProductsById[0]['image']."' style='width:20%;' name='imgs'>"; ?>
								...
								<div class="control-group">
									...
									<div class="controls">	
										<textarea class="span11" placeholder="Description" name = "description" >
											<?php echo $getProductsById[0]['description']; ?>
										</textarea>
									</div>
									<div class="control-group">
										<label class="control-label">Price :</label>
										<div class="controls">
											<input type="text" class="span11" placeholder="price" name = "price" value="<?php echo $getProductsById[0]['price']; ?> đ" /> *
										</div>
