<?php
  ...
  if(isset($_GET['id']))
  {
	  ...
	  $getProtypebyId = $protypes->getProtypebyId($id);
  }
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="updateProtype.php?id=<?php echo $id; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								<label class="control-label">Manufacture Name :</label>
								<div class="controls">
									<input type="text" class="span11" placeholder="Manufacture name" name="type_name" value="<?php echo $getProtypebyId[0]['type_name']; ?>" /> *
								</div>
							</div>
							...
							<div class="control-group">
									...
									<div class="controls">
									<?php echo "<img src='../images/".$getProtypebyId[0]['type_img']."' style='width:20%;' name='imgs'>"; ?>
