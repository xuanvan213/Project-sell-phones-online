<?php
  ...
  if(isset($_GET['id']))
  {
	  ...
	  $getManubyID = $manufactures->getManubyID($id);
  }
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="updateManu.php?id=<?php echo $id; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								<label class="control-label">Manufacture Name :</label>
								<div class="controls">
									<input type="text" class="span11" placeholder="Manufacture name" name="manu_name" value="<?php echo $getManubyID[0]['manu_name']; ?>" /> *
								</div>
							</div>
							...
							<div class="control-group">
									...
									<div class="controls">
									<?php echo "<img src='../images/".$getManubyID[0]['manu_img']."' style='width:20%;' name='imgs'>"; ?>
